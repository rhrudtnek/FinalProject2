<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <h3><center>EDIT ADDRESS</center></h3>
    <input type="hidden" id="addr_number" name="addr_number" value=${param.addnum}>
      <label for="address" style="color: gray">배송지명</label><br />
      <input type="text" id="addr_name" name="addr_name" style="width:100%; border: 0px; border-bottom: 1px solid gray" >
      <p></p>
...
<div id="post1">
    ...
    <div id="post2">
      ...
      style="border: 0px;
        ...
        cursor:pointer;
        margin-top: 10px;"
      onclick="checkPost(); return false;"
